        ...
        <div>
            ...
            <div
                style={{
                    ...
                    justifyContent: "flex-start", // Keep items starting from the left
            ...
            >
                ...
                <p
                    style={{
                        flexGrow: 1, // This makes the paragraph take the remaining width
                        maxWidth: "800px",
                        lineHeight: "1.8",
                        fontSize: "16px",
            ...
            >
                <p style={{ margin: "10px 0" }}>The Generics</p>
            </footer>
        </div>
    );
};
